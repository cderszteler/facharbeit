...
besitzt die oben dargestellte \hyperref[fig:mandelbrot-set]{Figur (3.1)} einen Farbverlauf.
Ein schwarzer Pixel repräsentiert dabei einen Wert für $c$, der sich innerhalb der
Mandelbrot-Menge befindet.
Der, in diesem Fall grüne, Farbverlauf gibt an, wie viele Iterationen es benötigte,
...
Iterationen benötigte es, um $c$ aus $\mathbb{M}$ auszuschließen\footnote{
  Vgl. z.B. dick markierten Werte für $c_1 = 1 \text{ und } c_3 = 0.5$ in
  \hyperref[tab:iterations-example]{Tabelle 2.1}.
