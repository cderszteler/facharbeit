...
\vspace*{-2ex}
\begin{figure}[H]\figuretag{A.8}\label{fig:mandelbrot-set-max-border-1}
\centering
...
\begin{figure}[H]\figuretag{A.8}\label{fig:mandelbrot-set-max-border-2}
\centering
\begin{minipage}[t]{0.48\textwidth}
  \centering
...
% TODO: Replace with last number
\noindent\textbf{A.Last:}\label{app:last}
\vspace*{1em}
\lstinputlisting[
  language=Python,
